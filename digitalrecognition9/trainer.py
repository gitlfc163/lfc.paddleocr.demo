...
class Trainer(object):
    ...
    def train(self, train_datasets, start_epoch, end_epoch, save_path):
        ...
        for i in range(start_epoch, end_epoch):
            ...
            paddle.save(self.optimizer.state_dict(), './model/{}/mnist_epoch{}'.format(save_path,i)+'.pdopt')
            paddle.save(self.model.state_dict(), './model/{}/mnist_epoch{}'.format(save_path,i)+'.pdparams')
        self.save()